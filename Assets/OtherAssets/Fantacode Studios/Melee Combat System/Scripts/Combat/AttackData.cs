...
{
    [CustomIcon(FolderPath.DataIcons + "Attack Icon.png")]
    [Icon(FolderPath.DataIcons + "Attack Icon.png")]
    [CreateAssetMenu(menuName = "Melee Combat System/Create Attack")]
    public class AttackData : ScriptableObject
    {
        ...
        [SerializeField] RotationSettings rotateToTargetSettings;
        ...
        public RotationSettings RotateToTargetSettings => rotateToTargetSettings;
        public RotationType RotationType => rotateToTargetSettings.RotationType;
        public float RotateStartTime => rotateToTargetSettings.RotateStartTime;
        public float RotateEndTime => rotateToTargetSettings.RotateEndTime;
        ...
        private void OnValidate()
        {
            ...
            if (reaction.LegacyAnimationClip != null && reaction.animationClipInfo.clip == null)
                reaction.animationClipInfo.clip = reaction.LegacyAnimationClip;

            if (blockedReaction.LegacyAnimationClip != null && blockedReaction.animationClipInfo.clip == null)
                blockedReaction.animationClipInfo.clip = blockedReaction.LegacyAnimationClip;
        }
    ...
    public enum RotationType { AlwaysRotate, Linear, Snap }
    ...
    public class RotationSettings
    {
        ...
        [Tooltip("Specifies how the rotation should happen.")]
        [SerializeField] private RotationType rotationType;

        [Tooltip("The start time of the movement, relative to the animation clip.")]
        public float rotateStartTime = 0f;

        [Tooltip("The end time of the movement, relative to the animation clip.")]
        public float rotateEndTime = 1f;

        public float RotationOffset => rotationOffset;
        public RotationType RotationType => rotationType;

        public float RotateStartTime => rotateStartTime;
        public float RotateEndTime => rotateEndTime;
    }
