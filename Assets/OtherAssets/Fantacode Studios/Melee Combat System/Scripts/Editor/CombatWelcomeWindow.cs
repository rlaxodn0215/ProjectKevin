...
namespace FS_CombatSystem
{
    ...
    public class CombatWelcomeWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/Melee Combat System/Support/Discord")]
        public static void InitDiscord()
        {
            Application.OpenURL("https://discord.gg/QNe4AMYT");
        }
        [MenuItem("Tools/Melee Combat System/Support/Youtube")]
        ...
        [MenuItem("Tools/Melee Combat System/Welcome Window")]
        ...
        private void OnGUI()
        {
            ...
            if (GUI.Button(new Rect(155, 195, 150, 35), "Create Enemy"))
                CreateCombatCharacterEditorWindow.InitEnemySetupWindow();
        ...
        [MenuItem("Tools/Melee Combat System/Import Tag Manager", false, 600, priority = 4)]
