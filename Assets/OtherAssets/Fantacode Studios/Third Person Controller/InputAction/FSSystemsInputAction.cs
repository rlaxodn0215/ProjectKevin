...
//     version 1.18.0
//     from Assets/OtherAssets/Fantacode Studios/Third Person Controller/InputAction/FSSystemsInputAction.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/OtherAssets/Fantacode Studios/Third Person Controller/InputAction/FSSystemsInputAction.inputactions".
/// </summary>
/// <remarks>
...
public partial class @FSSystemsInputAction: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""Swim"",
            ""id"": ""a2d9ba7f-7f24-4e43-a899-b5ed010224a9"",
            ""actions"": [
                {
                    ""name"": ""MoveDownKey"",
                    ""type"": ""Button"",
                    ""id"": ""da98cca6-b8cf-419c-9fe0-ca5fcbb1da50"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""MoveUpKey"",
                    ""type"": ""Button"",
                    ""id"": ""7a1d9210-ab45-42f8-bb1a-eea989d241e9"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""11e15f99-2d8a-4d2b-86cc-62f62defc2a2"",
                    ""path"": ""<Gamepad>/buttonWest"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""6d9e838c-1ccc-4fce-a4dd-bb239530611b"",
                    ""path"": ""<Keyboard>/c"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""641ec710-5663-4cf6-b1d8-916acbf125db"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""bafe66e7-f207-47c5-b9f2-f452951b2192"",
                    ""path"": ""<Gamepad>/buttonEast"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        m_Swim_MoveDownKey = m_Swim.FindAction("MoveDownKey", throwIfNotFound: true);
        m_Swim_MoveUpKey = m_Swim.FindAction("MoveUpKey", throwIfNotFound: true);
    }
    ...
    ~@FSSystemsInputAction()
    {
        ...
        UnityEngine.Debug.Assert(!m_Swim.enabled, "This will cause a leak and performance issues, FSSystemsInputAction.Swim.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Swim_MoveDownKey;
    private readonly InputAction m_Swim_MoveUpKey;
    /// <summary>
    /// Provides access to input actions defined in input action map "Swim".
    /// </summary>
    public struct SwimActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public SwimActions(@FSSystemsInputAction wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Swim/MoveDownKey".
        /// </summary>
        public InputAction @MoveDownKey => m_Wrapper.m_Swim_MoveDownKey;
        /// <summary>
        /// Provides access to the underlying input action "Swim/MoveUpKey".
        /// </summary>
        public InputAction @MoveUpKey => m_Wrapper.m_Swim_MoveUpKey;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="SwimActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        public void AddCallbacks(ISwimActions instance)
        {
            ...
            @MoveDownKey.started += instance.OnMoveDownKey;
            @MoveDownKey.performed += instance.OnMoveDownKey;
            @MoveDownKey.canceled += instance.OnMoveDownKey;
            @MoveUpKey.started += instance.OnMoveUpKey;
            @MoveUpKey.performed += instance.OnMoveUpKey;
            @MoveUpKey.canceled += instance.OnMoveUpKey;
        }
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="SwimActions.UnregisterCallbacks(ISwimActions)" />.
        /// </summary>
        /// <seealso cref="SwimActions.UnregisterCallbacks(ISwimActions)" />
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="SwimActions.AddCallbacks(ISwimActions)" />
        /// <seealso cref="SwimActions.RemoveCallbacks(ISwimActions)" />
        /// <seealso cref="SwimActions.UnregisterCallbacks(ISwimActions)" />
    ...
    /// <summary>
    /// Provides a new <see cref="SwimActions" /> instance referencing this action map.
    /// </summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "Swim" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="SwimActions.AddCallbacks(ISwimActions)" />
    /// <seealso cref="SwimActions.RemoveCallbacks(ISwimActions)" />
    ...
    {
        /// <summary>
        /// Method invoked when associated input action "MoveDownKey" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnMoveDownKey(InputAction.CallbackContext context);
        /// <summary>
        /// Method invoked when associated input action "MoveUpKey" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnMoveUpKey(InputAction.CallbackContext context);
    }
}
