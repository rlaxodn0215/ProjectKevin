...
namespace FS_CombatCore
{
    ...
    public class ReactionDataEditor : AnimationPreviewHandler
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                d.name = $"Type - {d.hitType.ToString()}, Direction - {d.direction.ToString()}";
        ...
        public override void HandleAnimationEnumPopup()
        {
            ...
            if (reactionsData.reactions.Count > 0)
            {
                ...
                if (currentAnimation < reactionsNameList.Count)
                    clip = reactionsData.reactions.FirstOrDefault(r => r.name == reactionsNameList[currentAnimation]).reaction.animationClipInfo.clip;
                else
                    currentAnimation = 0;
            }
